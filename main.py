        ...
        if self.gameOver:
            ...
            if self.points:
                for i, point in enumerate(self.points):
                    if i != 0:
                        cv2.line(imgMain, self.points[i-1], self.points[i], (0,100,0),20)
            ...
            cvzone.putTextRect(imgMain, f"Score: {self.score}", [50,80], scale=3, thickness=3, offset=100)
...
game = SnakeGameClass("C:\\Users\\rahul\\OneDrive\\Desktop\\snake_game\\image.png")
